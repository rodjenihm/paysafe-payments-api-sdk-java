...
public class CustomerPaymentHandleServiceTest extends BaseStubServerTest {
  ...
  void testCreateCustomerPaymentHandle_card_isSuccessful() throws PaysafeSdkException {
    ...
    stubServer.stub("POST", urlPath, UrlMatchType.PATH_EQUAL,
        StubResponse.builder()
            ...
            .bodyFile("customer_payment_handle/create_customer_payment_handle_card_response.json")
            .build());
  ...
  void testCreateCustomerPaymentHandle_multiuse_isSuccessful() throws PaysafeSdkException {
    ...
    stubServer.stub("POST", urlPath, UrlMatchType.PATH_EQUAL,
        StubResponse.builder()
            .status(200)
            .header("Content-Type", "application/json")
            .bodyFile("customer_payment_handle/create_multiuse_customer_payment_handle_response.json")
            .build());
  ...
  void testGetCustomerPaymentHandleByPaymentHandleId_isSuccessful() throws PaysafeSdkException {
    ...
    stubServer.stub("GET", urlPath, UrlMatchType.PATH_EQUAL,
        StubResponse.builder()
            .status(200)
            .header("Content-Type", "application/json")
            .bodyFile("customer_payment_handle/get_customer_payment_handle_by_id_response.json")
            .build());
    ...
    assertEquals(MandateStatus.PENDING, response.getMandates().get(0).getStatus());
  }
  ...
  void testUpdateCustomerPaymentHandle_card_isSuccessful() throws PaysafeSdkException {
    ...
    stubServer.stub("PUT", urlPath, UrlMatchType.PATH_EQUAL,
        StubResponse.builder()
            .status(200)
            .header("Content-Type", "application/json")
            .bodyFile("customer_payment_handle/update_customer_payment_handle_response.json")
            .build());
  ...
  void testDeleteCustomerPaymentHandle_isSuccessful() throws PaysafeSdkException {
    ...
    stubServer.stub("DELETE", urlPath, UrlMatchType.PATH_EQUAL,
        StubResponse.builder()
            .status(200)
            .build());
