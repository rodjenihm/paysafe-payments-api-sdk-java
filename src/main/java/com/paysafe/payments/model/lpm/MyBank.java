...
public class MyBank {
  ...
  private MyBank(final Builder builder) {
    setBankId(builder.bankId);
    setWebsiteId(builder.websiteId);
  ...
  public MyBank bankId(String bankId) {
    this.bankId = bankId;
    return this;
  }
  ...
  public MyBank websiteId(String websiteId) {
    this.websiteId = websiteId;
    return this;
  }

  /**
   * This is an identifier of the website.
   *
   * @return websiteId
   */
  ...
  public MyBank paymentId(String paymentId) {
  ...
  public MyBank emailSubject(String emailSubject) {
  ...
  public MyBank emailMessage(String emailMessage) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.bankId, myBank.bankId) &&
        Objects.equals(this.websiteId, myBank.websiteId) &&
        Objects.equals(this.paymentId, myBank.paymentId) &&
        Objects.equals(this.emailSubject, myBank.emailSubject) &&
        Objects.equals(this.emailMessage, myBank.emailMessage);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bankId, websiteId, paymentId, emailSubject, emailMessage);
  }
  ...
  public String toString() {
    ...
    return "class MyBank {\n"
        ...
        + "    websiteId: " + toIndentedString(websiteId) + "\n"
  ...
  public static final class Builder {
     ...
     * This is an identifier of the website.
     * <p>
     * Sets the websiteId and returns a reference to this Builder enabling method chaining.
     *
    ...
    /**
     * Returns a MyBank built from the parameters previously set.
     *
     * @return a MyBank built with parameters of this MyBank.Builder
     */
    public MyBank build() {
      return new MyBank(this);
    }
  }
}
