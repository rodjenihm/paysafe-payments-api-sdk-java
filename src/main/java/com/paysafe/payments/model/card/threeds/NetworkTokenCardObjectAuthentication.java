 ...
 */
public class NetworkTokenCardObjectAuthentication {
  ...
  public NetworkTokenCardObjectAuthentication() {
    super();
  }

  private NetworkTokenCardObjectAuthentication(Builder builder) {
    setEci(builder.eci);
  ...
  public NetworkTokenCardObjectAuthentication eci(String eci) {
    this.eci = eci;
    return this;
  }
  ...
  public NetworkTokenCardObjectAuthentication cavv(String cavv) {
    this.cavv = cavv;
    return this;
  }
  ...
  public NetworkTokenCardObjectAuthentication threeDResult(String threeDResult) {
  ...
  public NetworkTokenCardObjectAuthentication directoryServerTransactionId(String directoryServerTransactionId) {
  ...
  public NetworkTokenCardObjectAuthentication threeDSecureVersion(String threeDSecureVersion) {
  ...
  public NetworkTokenCardObjectAuthentication exemptionIndicator(String exemptionIndicator) {
  ...
  public boolean equals(Object o) {
    ...
    NetworkTokenCardObjectAuthentication networkTokenCardObjectAuthentication = (NetworkTokenCardObjectAuthentication) o;
    return Objects.equals(this.eci, networkTokenCardObjectAuthentication.eci) &&
        Objects.equals(this.cavv, networkTokenCardObjectAuthentication.cavv) &&
        Objects.equals(this.threeDResult, networkTokenCardObjectAuthentication.threeDResult) &&
        Objects.equals(this.directoryServerTransactionId, networkTokenCardObjectAuthentication.directoryServerTransactionId) &&
        Objects.equals(this.threeDSecureVersion, networkTokenCardObjectAuthentication.threeDSecureVersion) &&
        Objects.equals(this.exemptionIndicator, networkTokenCardObjectAuthentication.exemptionIndicator);
  }
  ...
  public String toString() {
    ...
    return "class NetworkTokenCardObjectAuthentication {\n"
  ...
  /**
   * {@code NetworkTokenCardObjectAuthentication} builder static inner class.
   */
  public static final class Builder {
    ...
    /**
     * Returns a {@code NetworkTokenCardObjectAuthentication} built from the parameters previously set.
     *
     * @return a {@code NetworkTokenCardObjectAuthentication} built with parameters of this {@code NetworkTokenCardObjectAuthentication.Builder}
     */
    public NetworkTokenCardObjectAuthentication build() {
      return new NetworkTokenCardObjectAuthentication(this);
    }
  }
}
