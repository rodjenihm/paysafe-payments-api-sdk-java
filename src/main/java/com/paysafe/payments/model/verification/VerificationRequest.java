...
/**
 * Contains internal details to be passed in the verification request. Verification allows merchants to validate a credit card without charging any amount on the card.
 */
public class VerificationRequest {
  ...
  /**
   * Required. This is the merchant reference number created by the merchant and submitted as part of the request.
   *
  ...
  /**
   * Required. This is the payment token generated by Paysafe that will be used for the Verification request.
   *
  ...
  @Override
  public int hashCode() {
    return Objects.hash(merchantRefNum, paymentHandleToken, customerIp, dupCheck, description, paymentFacilitator);
  }
  ...
  /**
   * Contains internal details to be passed in the verification request. Verification allows merchants to validate a credit card without charging any amount on the card. builder static inner class.
   */
  public static final class Builder {
    ...
    /**
     * Returns a VerificationRequest built from the parameters previously set.
     *
     * @return a VerificationRequest built with parameters of this VerificationRequest.Builder
     */
